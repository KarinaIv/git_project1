...
'''
                ...
                if flag:
                    if event.type == pygame.QUIT:
                        splashscr.terminate()
                    if event.type == pygame.KEYDOWN and event.key == pygame.K_r and not flag_rules:
                        flag_rules = True
                        print('rul')
                    ...
                    if event.type == pygame.MOUSEBUTTONDOWN and not flag_rules:
                        flag = False
                        splashscr.show = False
                        print('Клик удался')
                        continue
                    if event.type != pygame.KEYDOWN and \
                            event.type == pygame.MOUSEBUTTONDOWN and not flag_rules:
                        flag = False
                        splashscr.show = False
                        print('elsee')
